...
var _self = typeof window !== "undefined"
	...
	Prism = function () {
			...
			n = _self.Prism = {
				...
				"languages": {
					...
					"DFS"(e, t, r, a) {
						a = a || {};
						for (var l in e) {
							e.hasOwnProperty(l) && (t.call(e, l, e[l], r || l), n.util.type(e[l]) !== "Object" || a[n.util.objId(e[l])]
								? n.util.type(e[l]) !== "Array" || a[n.util.objId(e[l])] || (a[n.util.objId(e[l])] = !0, n.languages.DFS(e[l], t, l, a))
				...
				"highlightElement"(t, r, a) {
					...
					if (n.hooks.run("before-sanity-check", g), !g.code || !g.grammar) {
						return g.code && (n.hooks.run("before-highlight", g), g.element.textContent = g.code, n.hooks.run("after-highlight", g)), n.hooks.run("complete", g), void 0;
					}
					if (n.hooks.run("before-highlight", g), r && _self.Worker) {
						...
						g.highlightedCode = n.highlight(g.code, g.grammar, g.language), n.hooks.run("before-insert", g), g.element.innerHTML = g.highlightedCode, a && a.call(t), n.hooks.run("after-highlight", g), n.hooks.run("complete", g)
					}
				},
				"highlight"(e, t, a) {
								...
								for (var b = a, k = l; b < t.length; k += t[b].length, ++b) {
									...
									if (!(w instanceof s)) {
										...
										if (!_ && m && b != t.length - 1) {
											...
											for (var A = _.index + (d
												? _[1].length
												: 0), j = _.index + _[0].length, x = b, O = k, N = t.length; N > x && (j > O || !t[x].type && !t[x - 1].greedy); ++x) {
										...
										if (_) {
											...
											var E = new s(g, f
												? n.tokenize(_, f)
												: _, y, _, m);
											if (M.push(E), C && M.push(C), Array.prototype.splice.apply(t, M), P != 1 && n.matchGrammar(e, t, r, b, k, !0, g), i) {
												break
											}
										} else if (i) {
											break
		...
		if (r.stringify = function (e, t, a) {
			...
			if (e.alias) {
				var i = n.util.type(e.alias) === "Array"
					? e.alias
					: [e.alias];
			...
			return `<${l.tag} class="${l.classes.join(" ")}"${o
				? ` ${o}`
				: ""}>${l.content}</${l.tag}>`
		}, !_self.document) {
		...
		return a && (n.filename = a.src, n.manual || a.hasAttribute("data-manual") || (document.readyState !== "loading"
...
Prism.languages.php = Prism.languages.extend("clike", {
	...
	e.language === "php" && (/(?:<\?php|<\?)/gi).test(e.code) && (e.tokenStack = [], e.backupCode = e.code, e.code = e.code.replace(/(?:<\?php|<\?)[\s\S]*?(?:\?>|$)/gi, function (a) {
		for (var n = e.tokenStack.length; e.backupCode.indexOf(`___PHP${n}___`) !== -1;) {
			++n;
		}
		return e.tokenStack[n] = a, `___PHP${n}___`
	}), e.grammar = Prism.languages.markup)
}), Prism.hooks.add("before-insert", function (e) {
	e.language === "php" && e.backupCode && (e.code = e.backupCode, delete e.backupCode)
